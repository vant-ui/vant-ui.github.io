import{_ as e}from"./locales-e2cb6d3e.js";import{o as l,a as d,d as a,g as s,t as p,z as t}from"./vue-libs-19c20d28.js";const r={},c={class:"van-doc-markdown-body"},o=t(`<h1>Slider</h1><div class="van-doc-card"><h3 id="intro" tabindex="-1">Intro</h3><p>Used to select a value within a given range.</p></div><div class="van-doc-card"><h3 id="install" tabindex="-1">Install</h3><p>Register component globally via <code>app.use</code>, refer to <a href="#/en-US/advanced-usage#zu-jian-zhu-ce" target="_blank">Component Registration</a> for more registration ways.</p><pre><code class="language-js"><span class="hljs-keyword">import</span> { createApp } <span class="hljs-keyword">from</span> <span class="hljs-string">&#39;vue&#39;</span>;
...
</code></pre></div>`,10),h={class:"van-doc-card"},i=a("h3",{id:"custom-button",tabindex:"-1"},"Custom button",-1),u={class:"language-html"},m=a("span",{class:"hljs-tag"},[s("<"),a("span",{class:"hljs-name"},"van-slider"),s(),a("span",{class:"hljs-attr"},"v-model"),s("="),a("span",{class:"hljs-string"},'"value"'),s(">")],-1),g=a("span",{class:"hljs-tag"},[s("<"),a("span",{class:"hljs-name"},"template"),s(" #"),a("span",{class:"hljs-attr"},"button"),s(">")],-1),j=a("span",{class:"hljs-tag"},[s("<"),a("span",{class:"hljs-name"},"div"),s(),a("span",{class:"hljs-attr"},"class"),s("="),a("span",{class:"hljs-string"},'"custom-button"'),s(">")],-1),v=a("span",{class:"hljs-tag"},[s("</"),a("span",{class:"hljs-name"},"div"),s(">")],-1),b=a("span",{class:"hljs-tag"},[s("</"),a("span",{class:"hljs-name"},"template"),s(">")],-1),f=a("span",{class:"hljs-tag"},[s("</"),a("span",{class:"hljs-name"},"van-slider"),s(">")],-1),y=t(`<span class="hljs-tag">&lt;<span class="hljs-name">style</span>&gt;</span><span class="language-css">
...
</span><span class="hljs-tag">&lt;/<span class="hljs-name">style</span>&gt;</span>`,3),w=t(`<div class="van-doc-card"><h3 id="vertical" tabindex="-1">Vertical</h3><pre><code class="language-html"><span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">:style</span>=<span class="hljs-string">&quot;{ height: &#39;150px&#39; }&quot;</span>&gt;</span>
...
`),y,s(`
`)])])]),w])}const C=e(r,[["render",_]]);export{C as default};
