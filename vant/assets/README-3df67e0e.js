import{_ as l}from"./locales-e2cb6d3e.js";import{o as e,a as p,d as a,g as s,t as c,z as n}from"./vue-libs-19c20d28.js";const o={},r={class:"van-doc-markdown-body"},d=n(`<h1>Cascader</h1><div class="van-doc-card"><h3 id="intro" tabindex="-1">Intro</h3><p>The cascader component is used for the selection of multi-level data. The typical scene is the selection of provinces and cities.</p></div><div class="van-doc-card"><h3 id="install" tabindex="-1">Install</h3><p>Register component globally via <code>app.use</code>, refer to <a href="#/en-US/advanced-usage#zu-jian-zhu-ce" target="_blank">Component Registration</a> for more registration ways.</p><pre><code class="language-js"><span class="hljs-keyword">import</span> { createApp } <span class="hljs-keyword">from</span> <span class="hljs-string">&#39;vue&#39;</span>;
...
</code></pre></div>`,8),h={class:"van-doc-card"},i=a("h3",{id:"custom-content",tabindex:"-1"},"Custom Content",-1),j={class:"language-html"},u=n('<span class="hljs-tag">&lt;<span class="hljs-name">van-cascader</span> <span class="hljs-attr">v-model</span>=<span class="hljs-string">&quot;code&quot;</span> <span class="hljs-attr">title</span>=<span class="hljs-string">&quot;Select Area&quot;</span> <span class="hljs-attr">:options</span>=<span class="hljs-string">&quot;options&quot;</span>&gt;</span>',1),m=a("span",{class:"hljs-tag"},[s("<"),a("span",{class:"hljs-name"},"template"),s(" #"),a("span",{class:"hljs-attr"},"options-top"),s("="),a("span",{class:"hljs-string"},'"{ tabIndex }"'),s(">")],-1),g=a("span",{class:"hljs-tag"},[s("<"),a("span",{class:"hljs-name"},"div"),s(),a("span",{class:"hljs-attr"},"class"),s("="),a("span",{class:"hljs-string"},'"current-level"'),s(">")],-1),v=a("span",{class:"hljs-tag"},[s("</"),a("span",{class:"hljs-name"},"div"),s(">")],-1),f=a("span",{class:"hljs-tag"},[s("</"),a("span",{class:"hljs-name"},"template"),s(">")],-1),b=a("span",{class:"hljs-tag"},[s("</"),a("span",{class:"hljs-name"},"van-cascader"),s(">")],-1),y=n(`<span class="hljs-tag">&lt;<span class="hljs-name">style</span>&gt;</span><span class="language-css">
...
</span><span class="hljs-tag">&lt;/<span class="hljs-name">style</span>&gt;</span>`,3),w=n(`<pre><code class="language-js"><span class="hljs-keyword">import</span> { ref } <span class="hljs-keyword">from</span> <span class="hljs-string">&#39;vue&#39;</span>;
