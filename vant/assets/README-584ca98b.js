import{o as t,a,z as n}from"./vue-libs-6a67f9c6.js";const e={class:"van-doc-markdown-body"},l=n(`<h1>RollingText</h1><div class="van-doc-card"><h3 id="introduction" tabindex="-1">Introduction</h3><p>Rolling text animation, which can roll numbers and other types of text. Please upgrade <code>vant</code> to &gt;= v4.6.0 before using this component.</p></div><div class="van-doc-card"><h3 id="install" tabindex="-1">Install</h3><p>Register component globally via <code>app.use</code>, refer to <a href="#/en-US/advanced-usage#zu-jian-zhu-ce" target="_blank">Component Registration</a> for more registration ways.</p><pre><code class="language-js"><span class="hljs-keyword">import</span> { createApp } <span class="hljs-keyword">from</span> <span class="hljs-string">&#39;vue&#39;</span>;
...
rollingTextRef.<span class="hljs-property">value</span>?.<span class="hljs-title function_">start</span>();
</code></pre></div><h2 id="theming" tabindex="-1">Theming</h2><div class="van-doc-card"><h3 id="css-variables" tabindex="-1">CSS Variables</h3><p>The component provides the following CSS variables, which can be used to customize styles. Please refer to <a href="#/en-US/config-provider" target="_blank">ConfigProvider component</a>.</p><table><thead><tr><th>Name</th><th>Default Value</th><th>Description</th></tr></thead><tbody><tr><td>--van-rolling-text-background</td><td><em>inherit</em></td><td>Background color of a single digit</td></tr><tr><td>--van-rolling-text-color</td><td><em>var(--van-text-color)</em></td><td>Color of the number</td></tr><tr><td>--van-rolling-text-font-size</td><td><em>var(--van-font-size-md)</em></td><td>Font size of the number</td></tr><tr><td>--van-rolling-text-gap</td><td><em>0px</em></td><td>Spacing between digits</td></tr><tr><td>--van-rolling-text-item-width</td><td><em>15px</em></td><td>Width of a single digit</td></tr><tr><td>--van-rolling-text-item-border-radius</td><td><em>0px</em></td><td>Border radius of a single digit</td></tr></tbody></table></div>`,16),o=[l],h={__name:"README",setup(r,{expose:s}){return s({frontmatter:{}}),(c,d)=>(t(),a("div",e,o))}};export{h as default};
