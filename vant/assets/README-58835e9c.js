import{_ as s}from"./locales-ad8a99a3.js";import{o as t,a,z as n}from"./vue-libs-83dbabed.js";const e={},l={class:"van-doc-markdown-body"},o=n(`<h1>RollingText</h1><div class="van-doc-card"><h3 id="introduction" tabindex="-1">Introduction</h3><p>Rolling text animation, which can roll numbers and other types of text. Please upgrade <code>vant</code> to &gt;= v4.6.0 before using this component.</p></div><div class="van-doc-card"><h3 id="install" tabindex="-1">Install</h3><p>Register component globally via <code>app.use</code>, refer to <a href="#/en-US/advanced-usage#zu-jian-zhu-ce" target="_blank">Component Registration</a> for more registration ways.</p><pre><code class="language-js"><span class="hljs-keyword">import</span> { createApp } <span class="hljs-keyword">from</span> <span class="hljs-string">&#39;vue&#39;</span>;
