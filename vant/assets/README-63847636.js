...
</code></pre></div>`,8),h={class:"van-doc-card"},d=n('<h3 id="controlled-mode" tabindex="-1">Controlled Mode</h3><p>Supports both uncontrolled and controlled modes:</p><ul><li>When <code>v-model:active-tab</code> is not bound, the PickerGroup component completely controls the <code>tab</code> switching.</li><li>When <code>v-model:active-tab</code> is bound, PickerGroup supports controlled mode, and the <code>tab</code> switching is controlled by both the <code>v-model:active-tab</code> value and the component itself.</li></ul>',3),j={class:"language-html"},u=n('<span class="hljs-tag">&lt;<span class="hljs-name">van-button</span> <span class="hljs-attr">type</span>=<span class="hljs-string">&quot;primary&quot;</span> @<span class="hljs-attr">click</span>=<span class="hljs-string">&quot;setActiveTab&quot;</span>&gt;</span>',1),m=a("span",{class:"hljs-tag"},[s("</"),a("span",{class:"hljs-name"},"van-button"),s(">")],-1),g=n(`<span class="hljs-tag">&lt;<span class="hljs-name">van-picker-group</span>
  <span class="hljs-attr">v-model:active-tab</span>=<span class="hljs-string">&quot;activeTab&quot;</span>
  <span class="hljs-attr">title</span>=<span class="hljs-string">&quot;Title&quot;</span>
  <span class="hljs-attr">:tabs</span>=<span class="hljs-string">&quot;[&#39;Date&#39;, &#39;Time&#39;]&quot;</span>
  @<span class="hljs-attr">confirm</span>=<span class="hljs-string">&quot;onConfirm&quot;</span>
  @<span class="hljs-attr">cancel</span>=<span class="hljs-string">&quot;onCancel&quot;</span>
&gt;</span>`,1),f=n(`<span class="hljs-tag">&lt;<span class="hljs-name">van-date-picker</span>
    <span class="hljs-attr">v-model</span>=<span class="hljs-string">&quot;currentDate&quot;</span>
    <span class="hljs-attr">:min-date</span>=<span class="hljs-string">&quot;minDate&quot;</span>
    <span class="hljs-attr">:max-date</span>=<span class="hljs-string">&quot;maxDate&quot;</span>
  /&gt;</span>`,1),b=a("span",{class:"hljs-tag"},[s("<"),a("span",{class:"hljs-name"},"van-time-picker"),s(),a("span",{class:"hljs-attr"},"v-model"),s("="),a("span",{class:"hljs-string"},'"currentTime"'),s(" />")],-1),k=a("span",{class:"hljs-tag"},[s("</"),a("span",{class:"hljs-name"},"van-picker-group"),s(">")],-1),v=n(`<pre><code class="language-js"><span class="hljs-keyword">import</span> { ref } <span class="hljs-keyword">from</span> <span class="hljs-string">&#39;vue&#39;</span>;
<span class="hljs-keyword">import</span> { showToast } <span class="hljs-keyword">from</span> <span class="hljs-string">&#39;vant&#39;</span>;
...
</code></pre></div><h2 id="theming" tabindex="-1">Theming</h2><div class="van-doc-card"><h3 id="css-variables" tabindex="-1">CSS Variables</h3><p>The component provides the following CSS variables, which can be used to customize styles. Please refer to <a href="#/en-US/config-provider" target="_blank">ConfigProvider component</a>.</p><table><thead><tr><th>Name</th><th>Default Value</th><th>Description</th></tr></thead><tbody><tr><td>--van-picker-group-background</td><td><em>--van-background-2</em></td><td>-</td></tr></tbody></table></div>`,6);function y(t,_){return e(),p("div",r,[i,a("div",h,[d,a("pre",null,[a("code",j,[u,s(`
  toggle tab, current `+c(t.activeTab)+`
`,1),m,s(`
`),g,s(`
  `),f,s(`
  `),b,s(`
`),k,s(`
`)])]),v]),w])}const D=l(o,[["render",y]]);export{D as default};
