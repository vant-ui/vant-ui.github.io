import{_ as n}from"./locales-e2cb6d3e.js";import{o as l,a as p,d as a,g as s,t as d,z as t}from"./vue-libs-19c20d28.js";const r={},o={class:"van-doc-markdown-body"},c=t(`<h1>Uploader</h1><div class="van-doc-card"><h3 id="intro" tabindex="-1">Intro</h3><p>Used to upload a local image or file to the server and display a preview image and upload progress during the upload process. The Uploader component does not currently contain the interface logic for uploading files to the server, this step needs to be implemented by the user.</p></div><div class="van-doc-card"><h3 id="install" tabindex="-1">Install</h3><p>Register component globally via <code>app.use</code>, refer to <a href="#/en-US/advanced-usage#zu-jian-zhu-ce" target="_blank">Component Registration</a> for more registration ways.</p><pre><code class="language-js"><span class="hljs-keyword">import</span> { createApp } <span class="hljs-keyword">from</span> <span class="hljs-string">&#39;vue&#39;</span>;
...
</code></pre></div>`,10),i={class:"van-doc-card"},h=a("h3",{id:"preview-cover",tabindex:"-1"},"Preview Cover",-1),m={class:"language-html"},u=a("span",{class:"hljs-tag"},[s("<"),a("span",{class:"hljs-name"},"van-uploader"),s(),a("span",{class:"hljs-attr"},"v-model"),s("="),a("span",{class:"hljs-string"},'"fileList"'),s(">")],-1),j=a("span",{class:"hljs-tag"},[s("<"),a("span",{class:"hljs-name"},"template"),s(" #"),a("span",{class:"hljs-attr"},"preview-cover"),s("="),a("span",{class:"hljs-string"},'"{ file }"'),s(">")],-1),g=a("span",{class:"hljs-tag"},[s("<"),a("span",{class:"hljs-name"},"div"),s(),a("span",{class:"hljs-attr"},"class"),s("="),a("span",{class:"hljs-string"},'"preview-cover van-ellipsis"'),s(">")],-1),v=a("span",{class:"hljs-tag"},[s("</"),a("span",{class:"hljs-name"},"div"),s(">")],-1),f=a("span",{class:"hljs-tag"},[s("</"),a("span",{class:"hljs-name"},"template"),s(">")],-1),b=a("span",{class:"hljs-tag"},[s("</"),a("span",{class:"hljs-name"},"van-uploader"),s(">")],-1),y=t(`<span class="hljs-tag">&lt;<span class="hljs-name">style</span>&gt;</span><span class="language-css">
...
</span><span class="hljs-tag">&lt;/<span class="hljs-name">style</span>&gt;</span>`,3),w=t(`<div class="van-doc-card"><h3 id="preview-size" tabindex="-1">Preview Size</h3><p>Using <code>preview-size</code> prop to custom the size of preview image.</p><pre><code class="language-html"><span class="hljs-comment">&lt;!-- The default unit is px --&gt;</span>
