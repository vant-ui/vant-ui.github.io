...
</code></pre></div>`,5),o={class:"van-doc-card"},i=a("h3",{id:"imitate-video-barrage",tabindex:"-1"},"Imitate video barrage",-1),j={class:"language-html"},g=t('<span class="hljs-tag">&lt;<span class="hljs-name">van-barrage</span> <span class="hljs-attr">v-model</span>=<span class="hljs-string">&quot;list&quot;</span> <span class="hljs-attr">ref</span>=<span class="hljs-string">&quot;barrage&quot;</span> <span class="hljs-attr">:auto-play</span>=<span class="hljs-string">&quot;false&quot;</span>&gt;</span>',1),u=t('<span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">class</span>=<span class="hljs-string">&quot;video&quot;</span> <span class="hljs-attr">style</span>=<span class="hljs-string">&quot;width: 100%; height: 150px&quot;</span>&gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span>',2),m=a("span",{class:"hljs-tag"},[s("</"),a("span",{class:"hljs-name"},"van-barrage"),s(">")],-1),b=a("span",{class:"hljs-tag"},[s("<"),a("span",{class:"hljs-name"},"van-space"),s(),a("span",{class:"hljs-attr"},"style"),s("="),a("span",{class:"hljs-string"},'"margin-top: 10px"'),s(">")],-1),v=t('<span class="hljs-tag">&lt;<span class="hljs-name">van-button</span> @<span class="hljs-attr">click</span>=<span class="hljs-string">&quot;add&quot;</span> <span class="hljs-attr">type</span>=<span class="hljs-string">&quot;primary&quot;</span> <span class="hljs-attr">size</span>=<span class="hljs-string">&quot;small&quot;</span> <span class="hljs-attr">:disabled</span>=<span class="hljs-string">&quot;!isPlay&quot;</span>&gt;</span>',1),y=a("span",{class:"hljs-tag"},[s("</"),a("span",{class:"hljs-name"},"van-button"),s(">")],-1),_=t('<span class="hljs-tag">&lt;<span class="hljs-name">van-button</span> @<span class="hljs-attr">click</span>=<span class="hljs-string">&quot;toggle()&quot;</span> <span class="hljs-attr">size</span>=<span class="hljs-string">&quot;small&quot;</span>&gt;</span>',1),f=a("span",{class:"hljs-tag"},[s("</"),a("span",{class:"hljs-name"},"van-button"),s(">")],-1),x=a("span",{class:"hljs-tag"},[s("</"),a("span",{class:"hljs-name"},"van-space"),s(">")],-1),w=t(`<pre><code class="language-ts"><span class="hljs-keyword">export</span> <span class="hljs-keyword">default</span> {
  <span class="hljs-title function_">setup</span>(<span class="hljs-params"></span>) {
    <span class="hljs-keyword">const</span> defaultList = [
      { <span class="hljs-attr">id</span>: <span class="hljs-number">100</span>, <span class="hljs-attr">text</span>: <span class="hljs-string">&#39;Lightweight&#39;</span> },
      { <span class="hljs-attr">id</span>: <span class="hljs-number">101</span>, <span class="hljs-attr">text</span>: <span class="hljs-string">&#39;Customizable&#39;</span> },
...
`),b,s(`
  ...
  `),y,s(`
  `),_,s(`
    `+c(n.isPlay?"pause":"play")+`
  `,1),f,s(`
`),x,s(`
`)])]),w]),q])}const I=l(r,[["render",k]]);export{I as default};
