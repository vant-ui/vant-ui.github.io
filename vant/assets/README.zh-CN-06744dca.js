...
</code></pre></div>`,10),h={class:"van-doc-card"},i=a("h3",{id:"zi-ding-yi-an-niu",tabindex:"-1"},"自定义按钮",-1),u={class:"language-html"},j=a("span",{class:"hljs-tag"},[s("<"),a("span",{class:"hljs-name"},"van-slider"),s(),a("span",{class:"hljs-attr"},"v-model"),s("="),a("span",{class:"hljs-string"},'"value"'),s(">")],-1),g=a("span",{class:"hljs-tag"},[s("<"),a("span",{class:"hljs-name"},"template"),s(" #"),a("span",{class:"hljs-attr"},"button"),s(">")],-1),m=a("span",{class:"hljs-tag"},[s("<"),a("span",{class:"hljs-name"},"div"),s(),a("span",{class:"hljs-attr"},"class"),s("="),a("span",{class:"hljs-string"},'"custom-button"'),s(">")],-1),v=a("span",{class:"hljs-tag"},[s("</"),a("span",{class:"hljs-name"},"div"),s(">")],-1),b=a("span",{class:"hljs-tag"},[s("</"),a("span",{class:"hljs-name"},"template"),s(">")],-1),y=a("span",{class:"hljs-tag"},[s("</"),a("span",{class:"hljs-name"},"van-slider"),s(">")],-1),f=t(`<span class="hljs-tag">&lt;<span class="hljs-name">style</span>&gt;</span><span class="language-css">
...
</span><span class="hljs-tag">&lt;/<span class="hljs-name">style</span>&gt;</span>`,3),_=t(`<div class="van-doc-card"><h3 id="chui-zhi-fang-xiang" tabindex="-1">垂直方向</h3><p>设置 <code>vertical</code> 属性后，滑块会垂直展示，且高度为 100% 父元素高度。</p><pre><code class="language-html"><span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">:style</span>=<span class="hljs-string">&quot;{ height: &#39;150px&#39; }&quot;</span>&gt;</span>
...
`),f,s(`
`)])])]),_])}const z=l(c,[["render",w]]);export{z as default};
