...
</code></pre></div>`,5),o={class:"van-doc-card"},i=a("h3",{id:"mo-ni-shi-pin-dan-mu",tabindex:"-1"},"模拟视频弹幕",-1),j=a("p",null,[s("设置 "),a("code",null,"auto-play"),s(" 为 "),a("code",null,"false"),s(" 属性后，需要使用 "),a("code",null,"play()"),s(" 进行弹幕播放，暂停可以使用 "),a("code",null,"pause()"),s(" 实现。")],-1),g={class:"language-html"},u=n('<span class="hljs-tag">&lt;<span class="hljs-name">van-barrage</span> <span class="hljs-attr">v-model</span>=<span class="hljs-string">&quot;list&quot;</span> <span class="hljs-attr">ref</span>=<span class="hljs-string">&quot;barrage&quot;</span> <span class="hljs-attr">:auto-play</span>=<span class="hljs-string">&quot;false&quot;</span>&gt;</span>',1),m=n('<span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">class</span>=<span class="hljs-string">&quot;video&quot;</span> <span class="hljs-attr">style</span>=<span class="hljs-string">&quot;width: 100%; height: 150px&quot;</span>&gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span>',2),b=a("span",{class:"hljs-tag"},[s("</"),a("span",{class:"hljs-name"},"van-barrage"),s(">")],-1),v=a("span",{class:"hljs-tag"},[s("<"),a("span",{class:"hljs-name"},"van-space"),s(),a("span",{class:"hljs-attr"},"style"),s("="),a("span",{class:"hljs-string"},'"margin-top: 10px"'),s(">")],-1),_=n('<span class="hljs-tag">&lt;<span class="hljs-name">van-button</span> @<span class="hljs-attr">click</span>=<span class="hljs-string">&quot;add&quot;</span> <span class="hljs-attr">type</span>=<span class="hljs-string">&quot;primary&quot;</span> <span class="hljs-attr">size</span>=<span class="hljs-string">&quot;small&quot;</span> <span class="hljs-attr">:disabled</span>=<span class="hljs-string">&quot;!isPlay&quot;</span>&gt;</span>',1),y=a("span",{class:"hljs-tag"},[s("</"),a("span",{class:"hljs-name"},"van-button"),s(">")],-1),f=n('<span class="hljs-tag">&lt;<span class="hljs-name">van-button</span> @<span class="hljs-attr">click</span>=<span class="hljs-string">&quot;toggle()&quot;</span> <span class="hljs-attr">size</span>=<span class="hljs-string">&quot;small&quot;</span>&gt;</span>',1),x=a("span",{class:"hljs-tag"},[s("</"),a("span",{class:"hljs-name"},"van-button"),s(">")],-1),q=a("span",{class:"hljs-tag"},[s("</"),a("span",{class:"hljs-name"},"van-space"),s(">")],-1),k=n(`<pre><code class="language-ts"><span class="hljs-keyword">export</span> <span class="hljs-keyword">default</span> {
  <span class="hljs-title function_">setup</span>(<span class="hljs-params"></span>) {
    <span class="hljs-keyword">const</span> defaultList = [
      { <span class="hljs-attr">id</span>: <span class="hljs-number">100</span>, <span class="hljs-attr">text</span>: <span class="hljs-string">&#39;轻量&#39;</span> },
      { <span class="hljs-attr">id</span>: <span class="hljs-number">101</span>, <span class="hljs-attr">text</span>: <span class="hljs-string">&#39;可定制的&#39;</span> },
...
`),v,s(`
  ...
  `,1),x,s(`
`),q,s(`
`)])]),k]),w])}const N=l(d,[["render",B]]);export{N as default};
