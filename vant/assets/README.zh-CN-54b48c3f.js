...
</code></pre></div><div class="van-doc-card"><h3 id="vant-area-data" tabindex="-1">@vant/area-data</h3><p>Vant 官方提供了一份默认的中国省市区数据，可以通过 <a href="https://github.com/vant-ui/vant/tree/main/packages/vant-area-data" target="_blank">@vant/area-data</a> 引入：</p><pre><code class="language-bash"><span class="hljs-comment"># 通过 npm</span>
