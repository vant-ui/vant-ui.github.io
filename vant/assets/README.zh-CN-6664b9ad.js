...
</code></pre></div>`,10),i={class:"van-doc-card"},h=s("h3",{id:"shi-yong-imagepreview-zu-jian",tabindex:"-1"},"使用 ImagePreview 组件",-1),m=s("p",null,[t("如果需要在 ImagePreview 内嵌入组件或其他自定义内容，可以直接使用 ImagePreview 组件，并使用 "),s("code",null,"index"),t(" 插槽进行定制。使用前需要通过 "),s("code",null,"app.use"),t(" 等方式注册组件。")],-1),g={class:"language-html"},v=a('<span class="hljs-tag">&lt;<span class="hljs-name">van-image-preview</span> <span class="hljs-attr">v-model:show</span>=<span class="hljs-string">&quot;show&quot;</span> <span class="hljs-attr">:images</span>=<span class="hljs-string">&quot;images&quot;</span> @<span class="hljs-attr">change</span>=<span class="hljs-string">&quot;onChange&quot;</span>&gt;</span>',1),j=s("span",{class:"hljs-tag"},[t("<"),s("span",{class:"hljs-name"},"template"),t(),s("span",{class:"hljs-attr"},"v-slot:index"),t(">")],-1),w=s("span",{class:"hljs-tag"},[t("</"),s("span",{class:"hljs-name"},"template"),t(">")],-1),u=s("span",{class:"hljs-tag"},[t("</"),s("span",{class:"hljs-name"},"van-image-preview"),t(">")],-1),b=a(`<pre><code class="language-js"><span class="hljs-keyword">import</span> { ref } <span class="hljs-keyword">from</span> <span class="hljs-string">&#39;vue&#39;</span>;
...
</code></pre><p>Vant 从 4.0 版本开始不再支持 <code>babel-plugin-import</code> 插件，请参考 <a href="#/zh-CN/migrate-from-v3#yi-chu-babel-plugin-import" target="_blank">迁移指南</a> 移除该插件。</p></div>`,16);function f(e,x){return d(),l("div",p,[c,s("div",i,[h,m,s("pre",null,[s("code",g,[v,t(`
  `),j,t("第"+o(e.index+1)+"页",1),w,t(`
`),u,t(`
`)])]),b]),y])}const P=n(r,[["render",f]]);export{P as default};
