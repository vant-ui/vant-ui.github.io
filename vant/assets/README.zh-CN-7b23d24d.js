...
</code></pre></div><div class="van-doc-card"><h3 id="she-zhi-z-index" tabindex="-1">设置 z-index</h3><p>Overlay 组件默认的 z-index 层级为 <code>1</code>，你可以通过 <code>z-index</code> 属性设置它的 z-index 层级。</p><pre><code class="language-html"><span class="hljs-tag">&lt;<span class="hljs-name">van-overlay</span> <span class="hljs-attr">z-index</span>=<span class="hljs-string">&quot;100&quot;</span> /&gt;</span>
