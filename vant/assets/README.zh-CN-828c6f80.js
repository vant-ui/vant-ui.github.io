...
</code></pre></div><h2 id="dai-ma-yan-shi" tabindex="-1">代码演示</h2>`,4),r={class:"van-doc-card"},i=a("h3",{id:"ji-chu-yong-fa",tabindex:"-1"},"基础用法",-1),u=a("p",null,[s("下拉刷新时会触发 "),a("code",null,"refresh"),s(" 事件，在事件的回调函数中可以进行同步或异步操作，操作完成后将 "),a("code",null,"v-model"),s(" 设置为 "),a("code",null,"false"),s("，表示加载完成。")],-1),j={class:"language-html"},g=t('<span class="hljs-tag">&lt;<span class="hljs-name">van-pull-refresh</span> <span class="hljs-attr">v-model</span>=<span class="hljs-string">&quot;loading&quot;</span> @<span class="hljs-attr">refresh</span>=<span class="hljs-string">&quot;onRefresh&quot;</span>&gt;</span>',1),m=a("span",{class:"hljs-tag"},[s("<"),a("span",{class:"hljs-name"},"p"),s(">")],-1),_=a("span",{class:"hljs-tag"},[s("</"),a("span",{class:"hljs-name"},"p"),s(">")],-1),f=a("span",{class:"hljs-tag"},[s("</"),a("span",{class:"hljs-name"},"van-pull-refresh"),s(">")],-1),v=t(`<pre><code class="language-js"><span class="hljs-keyword">import</span> { ref } <span class="hljs-keyword">from</span> <span class="hljs-string">&#39;vue&#39;</span>;
...
</code></pre>`,1),b={class:"van-doc-card"},y=a("h3",{id:"cheng-gong-ti-shi",tabindex:"-1"},"成功提示",-1),x=a("p",null,[s("通过 "),a("code",null,"success-text"),s(" 可以设置刷新成功后的顶部提示文案。")],-1),q={class:"language-html"},w=t(`<span class="hljs-tag">&lt;<span class="hljs-name">van-pull-refresh</span>
...
&gt;</span>`,1),k=a("span",{class:"hljs-tag"},[s("<"),a("span",{class:"hljs-name"},"p"),s(">")],-1),z=a("span",{class:"hljs-tag"},[s("</"),a("span",{class:"hljs-name"},"p"),s(">")],-1),R=a("span",{class:"hljs-tag"},[s("</"),a("span",{class:"hljs-name"},"van-pull-refresh"),s(">")],-1),P={class:"van-doc-card"},N=a("h3",{id:"zi-ding-yi-ti-shi",tabindex:"-1"},"自定义提示",-1),C=a("p",null,"通过插槽可以自定义下拉刷新过程中的提示内容。",-1),E={class:"language-html"},S=t('<span class="hljs-tag">&lt;<span class="hljs-name">van-pull-refresh</span> <span class="hljs-attr">v-model</span>=<span class="hljs-string">&quot;isLoading&quot;</span> <span class="hljs-attr">:head-height</span>=<span class="hljs-string">&quot;80&quot;</span> @<span class="hljs-attr">refresh</span>=<span class="hljs-string">&quot;onRefresh&quot;</span>&gt;</span>',1),T=a("span",{class:"hljs-comment"},"<!-- 下拉提示，通过 scale 实现一个缩放效果 -->",-1),A=a("span",{class:"hljs-tag"},[s("<"),a("span",{class:"hljs-name"},"template"),s(" #"),a("span",{class:"hljs-attr"},"pulling"),s("="),a("span",{class:"hljs-string"},'"props"'),s(">")],-1),B=t(`<span class="hljs-tag">&lt;<span class="hljs-name">img</span>
    ...
    /&gt;</span>`,1),V=a("span",{class:"hljs-tag"},[s("</"),a("span",{class:"hljs-name"},"template"),s(">")],-1),D=a("span",{class:"hljs-comment"},"<!-- 释放提示 -->",-1),L=a("span",{class:"hljs-tag"},[s("<"),a("span",{class:"hljs-name"},"template"),s(" #"),a("span",{class:"hljs-attr"},"loosing"),s(">")],-1),I=t(`<span class="hljs-tag">&lt;<span class="hljs-name">img</span>
      <span class="hljs-attr">class</span>=<span class="hljs-string">&quot;doge&quot;</span>
      <span class="hljs-attr">src</span>=<span class="hljs-string">&quot;https://fastly.jsdelivr.net/npm/@vant/assets/doge.png&quot;</span>
    /&gt;</span>`,1),M=a("span",{class:"hljs-tag"},[s("</"),a("span",{class:"hljs-name"},"template"),s(">")],-1),O=a("span",{class:"hljs-comment"},"<!-- 加载提示 -->",-1),Y=a("span",{class:"hljs-tag"},[s("<"),a("span",{class:"hljs-name"},"template"),s(" #"),a("span",{class:"hljs-attr"},"loading"),s(">")],-1),$=t(`<span class="hljs-tag">&lt;<span class="hljs-name">img</span>
      <span class="hljs-attr">class</span>=<span class="hljs-string">&quot;doge&quot;</span>
      <span class="hljs-attr">src</span>=<span class="hljs-string">&quot;https://fastly.jsdelivr.net/npm/@vant/assets/doge-fire.jpeg&quot;</span>
    /&gt;</span>`,1),F=a("span",{class:"hljs-tag"},[s("</"),a("span",{class:"hljs-name"},"template"),s(">")],-1),G=a("span",{class:"hljs-tag"},[s("<"),a("span",{class:"hljs-name"},"p"),s(">")],-1),H=a("span",{class:"hljs-tag"},[s("</"),a("span",{class:"hljs-name"},"p"),s(">")],-1),J=a("span",{class:"hljs-tag"},[s("</"),a("span",{class:"hljs-name"},"van-pull-refresh"),s(">")],-1),K=t(`<span class="hljs-tag">&lt;<span class="hljs-name">style</span>&gt;</span><span class="language-css">
...
`)])])]),a("div",P,[N,C,a("pre",null,[a("code",E,[S,s(`
  ...
  `),Y,s(`
    `),$,s(`
  `),F,s(`
  `),G,s("刷新次数: "+l(n.count),1),H,s(`
`),J,s(`

`),K,s(`
`)])])]),Q])}const ss=e(c,[["render",U]]);export{ss as default};
