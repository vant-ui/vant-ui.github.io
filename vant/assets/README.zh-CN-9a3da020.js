...
</code></pre></div><h2 id="api" tabindex="-1">API</h2><div class="van-doc-card"><h3 id="props" tabindex="-1">Props</h3><table><thead><tr><th>参数</th><th>说明</th><th>类型</th><th>默认值</th></tr></thead><tbody><tr><td>v-model</td><td>当前输入的值</td><td><em>number | string</em></td><td>-</td></tr><tr><td>label</td><td>搜索框左侧文本</td><td><em>string</em></td><td>-</td></tr><tr><td>name <code>v3.2.3</code></td><td>名称，作为提交表单时的标识符</td><td><em>string</em></td><td>-</td></tr><tr><td>shape</td><td>搜索框形状，可选值为 <code>round</code></td><td><em>string</em></td><td><code>square</code></td></tr><tr><td>id <code>v3.2.2</code></td><td>搜索框 id，同时会设置 label 的 for 属性</td><td><em>string</em></td><td><code>van-search-n-input</code></td></tr><tr><td>background</td><td>搜索框外部背景色</td><td><em>string</em></td><td><code>#f2f2f2</code></td></tr><tr><td>maxlength</td><td>输入的最大字符数</td><td><em>number | string</em></td><td>-</td></tr><tr><td>placeholder</td><td>占位提示文字</td><td><em>string</em></td><td>-</td></tr><tr><td>clearable</td><td>是否启用清除图标，点击清除图标后会清空输入框</td><td><em>boolean</em></td><td><code>true</code></td></tr><tr><td>clear-icon <code>v3.0.12</code></td><td>清除图标名称或图片链接，等同于 Icon 组件的 <a href="#/zh-CN/icon#props" target="_blank">name 属性</a></td><td><em>string</em></td><td><code>clear</code></td></tr><tr><td>clear-trigger</td><td>显示清除图标的时机，<code>always</code> 表示输入框不为空时展示，<br><code>focus</code> 表示输入框聚焦且不为空时展示</td><td><em>string</em></td><td><code>focus</code></td></tr><tr><td>autofocus</td><td>是否自动聚焦，iOS 系统不支持该属性</td><td><em>boolean</em></td><td><code>false</code></td></tr><tr><td>show-action</td><td>是否在搜索框右侧显示取消按钮</td><td><em>boolean</em></td><td><code>false</code></td></tr><tr><td>action-text</td><td>取消按钮文字</td><td><em>string</em></td><td><code>取消</code></td></tr><tr><td>disabled</td><td>是否禁用输入框</td><td><em>boolean</em></td><td><code>false</code></td></tr><tr><td>readonly</td><td>是否将输入框设为只读状态，只读状态下无法输入内容</td><td><em>boolean</em></td><td><code>false</code></td></tr><tr><td>error</td><td>是否将输入内容标红</td><td><em>boolean</em></td><td><code>false</code></td></tr><tr><td>error-message</td><td>底部错误提示文案，为空时不展示</td><td><em>string</em></td><td>-</td></tr><tr><td>formatter <code>v3.0.12</code></td><td>输入内容格式化函数</td><td><em>(val: string) =&gt; string</em></td><td>-</td></tr><tr><td>format-trigger <code>v3.0.12</code></td><td>格式化函数触发的时机，可选值为 <code>onBlur</code></td><td><em>string</em></td><td><code>onChange</code></td></tr><tr><td>input-align</td><td>输入框内容对齐方式，可选值为 <code>center</code> <code>right</code></td><td><em>string</em></td><td><code>left</code></td></tr><tr><td>left-icon</td><td>输入框左侧图标名称或图片链接，等同于 Icon 组件的 <a href="#/zh-CN/icon#props" target="_blank">name 属性</a></td><td><em>string</em></td><td><code>search</code></td></tr><tr><td>right-icon</td><td>输入框右侧图标名称或图片链接，等同于 Icon 组件的 <a href="#/zh-CN/icon#props" target="_blank">name 属性</a></td><td><em>string</em></td><td>-</td></tr><tr><td>autocomplete <code>v3.2.3</code></td><td>input 标签原生的<a href="https://developer.mozilla.org/en-US/docs/Web/HTML/Attributes/autocomplete" target="_blank">自动完成属性</a></td><td><em>string</em></td><td>-</td></tr></tbody></table></div><div class="van-doc-card"><h3 id="events" tabindex="-1">Events</h3><table><thead><tr><th>事件名</th><th>说明</th><th>回调参数</th></tr></thead><tbody><tr><td>search</td><td>确定搜索时触发</td><td><em>value: string (当前输入的值)</em></td></tr><tr><td>update:model-value</td><td>输入框内容变化时触发</td><td><em>value: string (当前输入的值)</em></td></tr><tr><td>focus</td><td>输入框获得焦点时触发</td><td><em>event: Event</em></td></tr><tr><td>blur</td><td>输入框失去焦点时触发</td><td><em>event: Event</em></td></tr><tr><td>click-input</td><td>点击输入区域时触发</td><td><em>event: MouseEvent</em></td></tr><tr><td>click-left-icon <code>v3.4.0</code></td><td>点击左侧图标时触发</td><td><em>event: MouseEvent</em></td></tr><tr><td>click-right-icon <code>3.4.0</code></td><td>点击右侧图标时触发</td><td><em>event: MouseEvent</em></td></tr><tr><td>clear</td><td>点击清除按钮后触发</td><td><em>event: MouseEvent</em></td></tr><tr><td>cancel</td><td>点击取消按钮时触发</td><td>-</td></tr></tbody></table></div><div class="van-doc-card"><h3 id="fang-fa" tabindex="-1">方法</h3><p>通过 ref 可以获取到 Search 实例并调用实例方法，详见<a href="#/zh-CN/advanced-usage#zu-jian-shi-li-fang-fa" target="_blank">组件实例方法</a>。</p><table><thead><tr><th>方法名</th><th>说明</th><th>参数</th><th>返回值</th></tr></thead><tbody><tr><td>focus</td><td>获取输入框焦点</td><td>-</td><td>-</td></tr><tr><td>blur</td><td>取消输入框焦点</td><td>-</td><td>-</td></tr></tbody></table></div><div class="van-doc-card"><h3 id="lei-xing-ding-yi" tabindex="-1">类型定义</h3><p>组件导出以下类型定义：</p><pre><code class="language-ts"><span class="hljs-keyword">import</span> <span class="hljs-keyword">type</span> { <span class="hljs-title class_">SearchProps</span>, <span class="hljs-title class_">SearchShape</span>, <span class="hljs-title class_">SearchInstance</span> } <span class="hljs-keyword">from</span> <span class="hljs-string">&#39;vant&#39;</span>;
