import{o as a,a as n,z as t}from"./vue-libs-6a67f9c6.js";const l={class:"van-doc-markdown-body"},p=t(`<h1>RollingText 翻滚文本动效</h1><div class="van-doc-card"><h3 id="jie-shao" tabindex="-1">介绍</h3><p>文本翻滚动效，可以翻滚数字和其他类型文本。</p></div><div class="van-doc-card"><h3 id="yin-ru" tabindex="-1">引入</h3><p>通过以下方式来全局注册组件，更多注册方式请参考<a href="#/zh-CN/advanced-usage#zu-jian-zhu-ce" target="_blank">组件注册</a>。</p><pre><code class="language-js"><span class="hljs-keyword">import</span> { createApp } <span class="hljs-keyword">from</span> <span class="hljs-string">&#39;vue&#39;</span>;
...
</code></pre></div><h2 id="dai-ma-yan-shi" tabindex="-1">代码演示</h2><div class="van-doc-card"><h3 id="ji-chu-yong-fa" tabindex="-1">基础用法</h3><pre><code class="language-html"><span class="hljs-tag">&lt;<span class="hljs-name">van-rolling-text</span>
...
/&gt;</span>
</code></pre></div><div class="van-doc-card"><h3 id="she-zhi-fan-gun-fang-xiang" tabindex="-1">设置翻滚方向</h3><p>可以通过 <code>direction</code> 属性设置数字的翻滚方向。<code>up</code> 表示向上翻滚。</p><pre><code class="language-html"><span class="hljs-tag">&lt;<span class="hljs-name">van-rolling-text</span>
  <span class="hljs-attr">:start-num</span>=<span class="hljs-string">&quot;0&quot;</span>
...
/&gt;</span>
</code></pre></div><div class="van-doc-card"><h3 id="she-zhi-ge-shu-wei-ting-zhi-shun-xu" tabindex="-1">设置各数位停止顺序</h3><p>可以通过 <code>stop-order</code> 属性设置动画各个数位的停止先后顺序。默认先停止高位。设置 <code>rtl</code> 可以先从个位停止。</p><pre><code class="language-html"><span class="hljs-tag">&lt;<span class="hljs-name">van-rolling-text</span>
  <span class="hljs-attr">:start-num</span>=<span class="hljs-string">&quot;0&quot;</span>
  ...
  <span class="hljs-attr">direction</span>=<span class="hljs-string">&quot;up&quot;</span>
/&gt;</span>
</code></pre></div><div class="van-doc-card"><h3 id="fan-zhuan-fei-shu-zi-nei-rong" tabindex="-1">翻转非数字内容</h3><p>可以通过 <code>text-array</code> 属性设置非数字内容的翻转。</p><pre><code class="language-html"><span class="hljs-tag">&lt;<span class="hljs-name">van-rolling-text</span>
...
</code></pre></div><div class="van-doc-card"><h3 id="zi-ding-yi-yang-shi" tabindex="-1">自定义样式</h3><pre><code class="language-html"><span class="hljs-tag">&lt;<span class="hljs-name">van-rolling-text</span>
...
</code></pre></div><div class="van-doc-card"><h3 id="shou-dong-kong-zhi" tabindex="-1">手动控制</h3><p>通过 ref 获取到组件实例后，可以调用 <code>start</code>、<code>reset</code> 方法。</p><pre><code class="language-html"><span class="hljs-tag">&lt;<span class="hljs-name">van-rolling-text</span>
...
</code></pre></div><h2 id="api" tabindex="-1">API</h2><div class="van-doc-card"><h3 id="props" tabindex="-1">Props</h3><table><thead><tr><th>参数</th><th>说明</th><th>类型</th><th>默认值</th></tr></thead><tbody><tr><td>start-num</td><td>开始数值</td><td><em>number</em></td><td><code>0</code></td></tr><tr><td>target-num</td><td>目标数值</td><td><em>number</em></td><td>-</td></tr><tr><td>text-array</td><td>内容数组，翻转非数字内容，需要传此参数</td><td><em>Array</em></td><td><code>[]</code></td></tr><tr><td>duration</td><td>动画时长，单位为秒</td><td><em>number</em></td><td><code>2</code></td></tr><tr><td>direction</td><td>文本翻滚方向，值为 <code>down</code> 和 <code>up</code></td><td><em>string</em></td><td><code>down</code></td></tr><tr><td>auto-start</td><td>是否自动开始动画</td><td><em>boolean</em></td><td><code>true</code></td></tr><tr><td>stop-order</td><td>各个数位动画停止先后顺序，值为 <code>ltr</code> 和 <code>rtl</code></td><td><em>string</em></td><td><code>ltr</code></td></tr></tbody></table></div><div class="van-doc-card"><h3 id="fang-fa" tabindex="-1">方法</h3><p>通过 ref 可以获取到 RollingText 实例并调用实例方法，详见<a href="#/zh-CN/advanced-usage#zu-jian-shi-li-fang-fa" target="_blank">组件实例方法</a>。</p><table><thead><tr><th>方法名</th><th>说明</th><th>参数</th><th>返回值</th></tr></thead><tbody><tr><td>start</td><td>开始动画</td><td>-</td><td>-</td></tr><tr><td>reset</td><td>重置动画</td><td>-</td><td>-</td></tr></tbody></table></div><div class="van-doc-card"><h3 id="lei-xing-ding-yi" tabindex="-1">类型定义</h3><p>组件导出以下类型定义：</p><pre><code class="language-ts"><span class="hljs-keyword">import</span> <span class="hljs-keyword">type</span> {
