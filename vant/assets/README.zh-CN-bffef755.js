...
</code></pre><p>Vant 从 4.0 版本开始不再支持 <code>babel-plugin-import</code> 插件，请参考 <a href="#/zh-CN/migrate-from-v3#yi-chu-babel-plugin-import" target="_blank">迁移指南</a> 移除该插件。</p></div>`,17),o=[l];function p(c,i){return a(),t("div",e,o)}const j=s(d,[["render",p]]);export{j as default};
