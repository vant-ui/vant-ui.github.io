...
</code></pre></div>`,10),i={class:"van-doc-card"},h=a("h3",{id:"zi-ding-yi-yu-lan-yang-shi",tabindex:"-1"},"自定义预览样式",-1),j=a("p",null,[s("通过 "),a("code",null,"preview-cover"),s(" 插槽可以自定义覆盖在预览区域上方的内容。")],-1),u={class:"language-html"},m=a("span",{class:"hljs-tag"},[s("<"),a("span",{class:"hljs-name"},"van-uploader"),s(),a("span",{class:"hljs-attr"},"v-model"),s("="),a("span",{class:"hljs-string"},'"fileList"'),s(">")],-1),g=a("span",{class:"hljs-tag"},[s("<"),a("span",{class:"hljs-name"},"template"),s(" #"),a("span",{class:"hljs-attr"},"preview-cover"),s("="),a("span",{class:"hljs-string"},'"{ file }"'),s(">")],-1),v=a("span",{class:"hljs-tag"},[s("<"),a("span",{class:"hljs-name"},"div"),s(),a("span",{class:"hljs-attr"},"class"),s("="),a("span",{class:"hljs-string"},'"preview-cover van-ellipsis"'),s(">")],-1),f=a("span",{class:"hljs-tag"},[s("</"),a("span",{class:"hljs-name"},"div"),s(">")],-1),b=a("span",{class:"hljs-tag"},[s("</"),a("span",{class:"hljs-name"},"template"),s(">")],-1),y=a("span",{class:"hljs-tag"},[s("</"),a("span",{class:"hljs-name"},"van-uploader"),s(">")],-1),w=n(`<span class="hljs-tag">&lt;<span class="hljs-name">style</span>&gt;</span><span class="language-css">
...
</span><span class="hljs-tag">&lt;/<span class="hljs-name">style</span>&gt;</span>`,3),k=n(`<div class="van-doc-card"><h3 id="zi-ding-yi-yu-lan-da-xiao" tabindex="-1">自定义预览大小</h3><p>通过 <code>preview-size</code> 属性定义预览图和上传区域的大小。</p><pre><code class="language-html"><span class="hljs-comment">&lt;!-- 不指定单位，默认为 px --&gt;</span>
