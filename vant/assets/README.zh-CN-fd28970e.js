...
</code></pre></div>`,8),i={class:"van-doc-card"},j=n('<h3 id="shou-kong-mo-shi" tabindex="-1">受控模式</h3><p><code>PickerGroup</code> 中 <code>tab</code> 的切换支持非受控模式和受控模式：</p><ul><li>当未绑定 <code>v-model:active-tab</code> 时，PickerGroup 组件 <code>tab</code> 的切换完全由组件自身控制。</li><li>当绑定 <code>v-model:active-tab</code> 时，PickerGroup 支持受控模式，此时组件 <code>tab</code> 的切换同时支持 <code>v-model:active-tab</code> 的值和组件本身控制。</li></ul>',3),d={class:"language-html"},u=n('<span class="hljs-tag">&lt;<span class="hljs-name">van-button</span> <span class="hljs-attr">type</span>=<span class="hljs-string">&quot;primary&quot;</span> @<span class="hljs-attr">click</span>=<span class="hljs-string">&quot;setActiveTab&quot;</span>&gt;</span>',1),m=a("span",{class:"hljs-tag"},[s("</"),a("span",{class:"hljs-name"},"van-button"),s(">")],-1),g=n(`<span class="hljs-tag">&lt;<span class="hljs-name">van-picker-group</span>
  <span class="hljs-attr">v-model:active-tab</span>=<span class="hljs-string">&quot;activeTab&quot;</span>
  <span class="hljs-attr">title</span>=<span class="hljs-string">&quot;预约日期&quot;</span>
  <span class="hljs-attr">:tabs</span>=<span class="hljs-string">&quot;[&#39;选择日期&#39;, &#39;选择时间&#39;]&quot;</span>
  @<span class="hljs-attr">confirm</span>=<span class="hljs-string">&quot;onConfirm&quot;</span>
  @<span class="hljs-attr">cancel</span>=<span class="hljs-string">&quot;onCancel&quot;</span>
&gt;</span>`,1),k=n(`<span class="hljs-tag">&lt;<span class="hljs-name">van-date-picker</span>
    <span class="hljs-attr">v-model</span>=<span class="hljs-string">&quot;currentDate&quot;</span>
    <span class="hljs-attr">:min-date</span>=<span class="hljs-string">&quot;minDate&quot;</span>
    <span class="hljs-attr">:max-date</span>=<span class="hljs-string">&quot;maxDate&quot;</span>
  /&gt;</span>`,1),v=a("span",{class:"hljs-tag"},[s("<"),a("span",{class:"hljs-name"},"van-time-picker"),s(),a("span",{class:"hljs-attr"},"v-model"),s("="),a("span",{class:"hljs-string"},'"currentTime"'),s(" />")],-1),f=a("span",{class:"hljs-tag"},[s("</"),a("span",{class:"hljs-name"},"van-picker-group"),s(">")],-1),b=n(`<pre><code class="language-js"><span class="hljs-keyword">import</span> { ref } <span class="hljs-keyword">from</span> <span class="hljs-string">&#39;vue&#39;</span>;
<span class="hljs-keyword">import</span> { showToast } <span class="hljs-keyword">from</span> <span class="hljs-string">&#39;vant&#39;</span>;
...
</code></pre></div><h2 id="zhu-ti-ding-zhi" tabindex="-1">主题定制</h2><div class="van-doc-card"><h3 id="yang-shi-bian-liang" tabindex="-1">样式变量</h3><p>组件提供了下列 CSS 变量，可用于自定义样式，使用方法请参考 <a href="#/zh-CN/config-provider" target="_blank">ConfigProvider 组件</a>。</p><table><thead><tr><th>名称</th><th>默认值</th><th>描述</th></tr></thead><tbody><tr><td>--van-picker-group-background</td><td><em>--van-background-2</em></td><td>-</td></tr></tbody></table></div>`,6);function _(t,y){return p(),c("div",o,[h,a("div",i,[j,a("pre",null,[a("code",d,[u,s(`
  点击切换 tab，当前为 `+e(t.activeTab)+`
`,1),m,s(`
`),g,s(`
  `),k,s(`
  `),v,s(`
`),f,s(`
`)])]),b]),w])}const D=l(r,[["render",_]]);export{D as default};
