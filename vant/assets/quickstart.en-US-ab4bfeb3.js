import{_ as s}from"./locales-ed8bb270.js";import{o as n,a,z as t}from"./vue-libs-83dbabed.js";const e={},l={class:"van-doc-markdown-body"},p=t(`<h1>Quickstart</h1><h2 id="install" tabindex="-1">Install</h2><div class="van-doc-card"><h3 id="npm" tabindex="-1">npm</h3><p>Using <code>npm</code> to install:</p><pre><code class="language-bash"><span class="hljs-comment"># install latest Vant for Vue 3 project</span>
npm i vant
...
bun add vant
</code></pre></div><div class="van-doc-card"><h3 id="using-in-a-new-project" tabindex="-1">Using in a New Project</h3><p>If you need to create a new project, we recommend using <a href="https://github.com/web-infra-dev/rsbuild" target="_blank">Rsbuild</a>, <a href="https://vitejs.dev/" target="_blank">Vite</a> or <a href="https://nuxtjs.org/" target="_blank">Nuxt framework</a>.</p><h4 id="rsbuild" tabindex="-1">Rsbuild</h4><p>Rsbuild is a build tool based on Rspack, developed by the author of Vant, with first-class build speed and development experience, providing first-priority support for Vant.</p><p>You can create a Rsbuild project with the following command:</p><pre><code class="language-bash">npm create rsbuild@latest
</code></pre><p>Please visit the <a href="https://github.com/web-infra-dev/rsbuild" target="_blank">Rsbuild repository</a> for more information.</p><h4 id="example" tabindex="-1">Example</h4><p>Here are the example projects provided by Vant official. You can clone these projects and copy the code.</p><ul><li><a href="https://github.com/vant-ui/vant-demo/tree/master/vant/rsbuild" target="_blank">vant-demo - rsbuild</a>: Build an application using Vue 3, Vant 4, and Rsbuild.</li><li><a href="https://github.com/vant-ui/vant-demo/tree/master/vant/vite" target="_blank">vant-demo - vite</a>: Build an application using Vue 3, Vant 4, and Vite.</li><li><a href="https://github.com/vant-ui/vant-demo/tree/master/vant/nuxt3" target="_blank">vant-demo - nuxt3</a>: Build an application using Vue 3, Nuxt 3, and Vant 4.</li></ul></div><div class="van-doc-card"><h3 id="cdn" tabindex="-1">CDN</h3><p>If you only need to develop a simple HTML page, you can directly include the CDN links in the HTML file. After that, you can access all the components through the global variable <code>vant</code>.</p><pre><code class="language-html"><span class="hljs-comment">&lt;!-- import style --&gt;</span>
