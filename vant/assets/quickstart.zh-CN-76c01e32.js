...
bun add vant
</code></pre></div><div class="van-doc-card"><h3 id="zai-xin-xiang-mu-zhong-shi-yong" tabindex="-1">在新项目中使用</h3><p>如果你需要新建一个项目，我们推荐使用 <a href="https://github.com/web-infra-dev/rsbuild" target="_blank">Rsbuild</a>，<a href="https://cn.vitejs.dev/" target="_blank">Vite</a> 或 <a href="https://nuxt.com" target="_blank">Nuxt 框架</a>。</p><p>以下是 Vant 官方提供的一些示例项目，你可以克隆该项目，并直接拷贝代码来使用。</p><ul><li><a href="https://github.com/vant-ui/vant-demo/tree/master/vant/rsbuild" target="_blank">vant-demo - rsbuild</a>：使用 Vue 3、Vant 4、Rsbuild 搭建应用</li><li><a href="https://github.com/vant-ui/vant-demo/tree/master/vant/vite" target="_blank">vant-demo - vite</a>：使用 Vue 3、Vant 4、Vite 搭建应用</li><li><a href="https://github.com/vant-ui/vant-demo/tree/master/vant/nuxt3" target="_blank">vant-demo - nuxt3</a>：使用 Vue 3、Nuxt 3、Vant 4 搭建应用。</li></ul></div><div class="van-doc-card"><h3 id="tong-guo-cdn-an-zhuang" tabindex="-1">通过 CDN 安装</h3><p>如果你只需要开发一个简单的 HTML 页面，那么可以直接在 HTML 文件中引入 CDN 链接，之后你可以通过全局变量 <code>vant</code> 访问到所有组件。</p><pre><code class="language-html"><span class="hljs-comment">&lt;!-- 引入样式文件 --&gt;</span>
