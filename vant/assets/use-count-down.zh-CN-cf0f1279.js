import{_ as e}from"./locales-e2cb6d3e.js";import{o as p,a as d,d as n,g as s,t,z as l}from"./vue-libs-19c20d28.js";const c={},o={class:"van-doc-markdown-body"},r=n("h1",null,"useCountDown",-1),h=n("div",{class:"van-doc-card"},[n("h3",{id:"jie-shao",tabindex:"-1"},"介绍"),n("p",null,"提供倒计时管理能力。")],-1),i=n("h2",{id:"dai-ma-yan-shi",tabindex:"-1"},"代码演示",-1),u={class:"van-doc-card"},j=n("h3",{id:"ji-ben-yong-fa",tabindex:"-1"},"基本用法",-1),m={class:"language-html"},_=n("span",{class:"hljs-tag"},[s("<"),n("span",{class:"hljs-name"},"span"),s(">")],-1),b=n("span",{class:"hljs-tag"},[s("</"),n("span",{class:"hljs-name"},"span"),s(">")],-1),g=n("span",{class:"hljs-tag"},[s("<"),n("span",{class:"hljs-name"},"span"),s(">")],-1),y=n("span",{class:"hljs-tag"},[s("</"),n("span",{class:"hljs-name"},"span"),s(">")],-1),w=n("span",{class:"hljs-tag"},[s("<"),n("span",{class:"hljs-name"},"span"),s(">")],-1),v=n("span",{class:"hljs-tag"},[s("</"),n("span",{class:"hljs-name"},"span"),s(">")],-1),f=n("span",{class:"hljs-tag"},[s("<"),n("span",{class:"hljs-name"},"span"),s(">")],-1),C=n("span",{class:"hljs-tag"},[s("</"),n("span",{class:"hljs-name"},"span"),s(">")],-1),k=n("span",{class:"hljs-tag"},[s("<"),n("span",{class:"hljs-name"},"span"),s(">")],-1),D=n("span",{class:"hljs-tag"},[s("</"),n("span",{class:"hljs-name"},"span"),s(">")],-1),x=n("span",{class:"hljs-tag"},[s("<"),n("span",{class:"hljs-name"},"span"),s(">")],-1),T=n("span",{class:"hljs-tag"},[s("</"),n("span",{class:"hljs-name"},"span"),s(">")],-1),N=l(`<pre><code class="language-js"><span class="hljs-keyword">import</span> { useCountDown } <span class="hljs-keyword">from</span> <span class="hljs-string">&#39;@vant/use&#39;</span>;
...
</code></pre>`,1),z=l(`<div class="van-doc-card"><h3 id="hao-miao-ji-xuan-ran" tabindex="-1">毫秒级渲染</h3><p>倒计时默认每秒渲染一次，设置 millisecond 选项可以开启毫秒级渲染。</p><pre><code class="language-js"><span class="hljs-keyword">import</span> { useCountDown } <span class="hljs-keyword">from</span> <span class="hljs-string">&#39;@vant/use&#39;</span>;
