...
</code></pre></div><div class="van-doc-card"><h3 id="fan-hui-zhi" tabindex="-1">返回值</h3><table><thead><tr><th>参数</th><th>说明</th><th>类型</th></tr></thead><tbody><tr><td>width</td><td>宽度</td><td><em>number</em></td></tr><tr><td>height</td><td>高度</td><td><em>number</em></td></tr><tr><td>top</td><td>顶部与视图窗口左上角的距离</td><td><em>number</em></td></tr><tr><td>left</td><td>左侧与视图窗口左上角的距离</td><td><em>number</em></td></tr><tr><td>right</td><td>右侧与视图窗口左上角的距离</td><td><em>number</em></td></tr><tr><td>bottom</td><td>底部与视图窗口左上角的距离</td><td><em>number</em></td></tr></tbody></table></div>`,7),l=[d],h={__name:"use-rect.zh-CN",setup(o,{expose:s}){return s({frontmatter:{}}),(r,p)=>(t(),n("div",e,l))}};export{h as default};
