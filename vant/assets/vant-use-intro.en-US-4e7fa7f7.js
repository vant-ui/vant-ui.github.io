import{_ as t}from"./locales-e2cb6d3e.js";import{o as e,a,z as s}from"./vue-libs-19c20d28.js";const n={},d={class:"van-doc-markdown-body"},l=s(`<h1>Composables</h1><div class="van-doc-card"><h3 id="intro" tabindex="-1">Intro</h3><p>Vant provide some built-in composition APIs, you can directly use these APIs for development.</p></div><div class="van-doc-card"><h3 id="install" tabindex="-1">Install</h3><p>Although <code>@vant/use</code> is already included in Vant&#39;s dependencies, it is still recommended to install this package explicitly:</p><pre><code class="language-shell"><span class="hljs-meta prompt_"># </span><span class="language-bash">with npm</span>
npm i @vant/use
