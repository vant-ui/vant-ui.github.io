import{o as a,a as t,z as n}from"./vue-libs.d5ee895a.js";const l={class:"van-doc-markdown-body"},e=n(`<h1>BackTop</h1><div class="van-doc-card"><h3 id="intro" tabindex="-1">Intro</h3><p>A button to back to top.</p></div><div class="van-doc-card"><h3 id="install" tabindex="-1">Install</h3><p>Register component globally via <code>app.use</code>, refer to <a href="#/en-US/advanced-usage#zu-jian-zhu-ce" target="_blank">Component Registration</a> for more registration ways.</p><pre><code class="language-js"><span class="hljs-keyword">import</span> { createApp } <span class="hljs-keyword">from</span> <span class="hljs-string">&#39;vue&#39;</span>;
...
</code></pre></div><h2 id="usage" tabindex="-1">Usage</h2><div class="van-doc-card"><h3 id="basic-usage" tabindex="-1">Basic Usage</h3><p>Please scroll the demo page to display the back top button.</p><pre><code class="language-html"><span class="hljs-tag">&lt;<span class="hljs-name">van-cell</span> <span class="hljs-attr">v-for</span>=<span class="hljs-string">&quot;item in list&quot;</span> <span class="hljs-attr">:key</span>=<span class="hljs-string">&quot;item&quot;</span> <span class="hljs-attr">:title</span>=<span class="hljs-string">&quot;item&quot;</span> /&gt;</span> <span class="hljs-tag">&lt;<span class="hljs-name">van-back-top</span> /&gt;</span>
...
</code></pre></div><h2 id="api" tabindex="-1">API</h2><div class="van-doc-card"><h3 id="props" tabindex="-1">Props</h3><table><thead><tr><th>Attribute</th><th>Description</th><th>Type</th><th>Default</th></tr></thead><tbody><tr><td>target</td><td>Can be a <code>selector</code> or <code>HTMLElement</code></td><td><em>string | HTMLElement</em></td><td>-</td></tr><tr><td>right</td><td>Right distance of the page, the default unit is px</td><td><em>number | string</em></td><td><code>30</code></td></tr><tr><td>bottom</td><td>Bottom distance of the page, the default unit is px</td><td><em>number | string</em></td><td><code>40</code></td></tr><tr><td>visibility-height</td><td>The button will not show until the scroll height reaches this value</td><td><em>number</em></td><td><code>200</code></td></tr><tr><td>teleport</td><td>Specifies a target element where BackTop will be mounted</td><td><em>string | Element</em></td><td><code>body</code></td></tr></tbody></table></div><div class="van-doc-card"><h3 id="slots" tabindex="-1">Slots</h3><table><thead><tr><th>Name</th><th>Description</th></tr></thead><tbody><tr><td>default</td><td>customize default content</td></tr></tbody></table></div><div class="van-doc-card"><h3 id="types" tabindex="-1">Types</h3><p>The component exports the following type definitions:</p><pre><code class="language-ts"><span class="hljs-keyword">import</span> <span class="hljs-keyword">type</span> { <span class="hljs-title class_">BackTopProps</span>, <span class="hljs-title class_">BackTopThemeVars</span> } <span class="hljs-keyword">from</span> <span class="hljs-string">&#39;vant&#39;</span>;
</code></pre></div><h2 id="theming" tabindex="-1">Theming</h2><div class="van-doc-card"><h3 id="css-variables" tabindex="-1">CSS Variables</h3><p>The component provides the following CSS variables, which can be used to customize styles. Please refer to <a href="#/en-US/config-provider" target="_blank">ConfigProvider component</a>.</p><table><thead><tr><th>Name</th><th>Default Value</th><th>Description</th></tr></thead><tbody><tr><td>--van-back-top-size</td><td><em>40px</em></td><td>-</td></tr><tr><td>--van-back-top-icon-size</td><td><em>20px</em></td><td>-</td></tr><tr><td>--van-back-top-text-color</td><td><em>#fff</em></td><td>-</td></tr><tr><td>--van-back-top-background</td><td><em>var(--van-blue)</em></td><td>-</td></tr></tbody></table></div>`,14),p=[e],i={__name:"README",setup(c,{expose:s}){return s({frontmatter:{}}),(r,d)=>(a(),t("div",l,p))}};export{i as default};
