import{o as n,a,z as e}from"./vue-libs.d5ee895a.js";const t={class:"van-doc-markdown-body"},l=e(`<h1>Quickstart</h1><h2 id="install" tabindex="-1">Install</h2><div class="van-doc-card"><h3 id="npm" tabindex="-1">npm</h3><p>Using <code>npm</code> to install:</p><pre><code class="language-bash"><span class="hljs-comment"># install latest Vant for Vue 3 project</span>
npm i vant
...
</code></pre><blockquote><p>Tip: &quot;Full Import&quot; and &quot;On-demand Import&quot; should not be used at the same time, otherwise it will lead to problems such as code duplication and style overrides.</p></blockquote><h4 id="tips" tabindex="-1">Tips</h4><ul><li>&quot;Full Import&quot; and &quot;On-demand Import&quot; should not be used at the same time, otherwise it will lead to problems such as code duplication and style overrides.</li><li>unplugin-vue-components is not officially maintained by Vant. If you encounter issues when using this plugin, please feedback to <a href="https://github.com/antfu/unplugin-vue-components" target="_blank">antfu/unplugin-vue-components</a> repository.</li></ul></div><h2 id="with-frameworks" tabindex="-1">With Frameworks</h2><div class="van-doc-card"><h3 id="use-vant-in-nuxt-3" tabindex="-1">Use Vant in Nuxt 3</h3><p>When using Vant in Nuxt 3, you should add <code>/vant/</code> to the <code>build.transpile</code>:</p><pre><code class="language-ts"><span class="hljs-keyword">import</span> { defineNuxtConfig } <span class="hljs-keyword">from</span> <span class="hljs-string">&#39;nuxt&#39;</span>;
...
</code></pre><p>Reference:</p><ul><li><a href="https://github.com/nuxt/framework/issues/6761" target="_blank">nuxt/framework#6761</a></li><li><a href="https://github.com/nuxt/framework/issues/4084" target="_blank">nuxt/framework#4084</a></li></ul></div>`,10),p=[l],d={__name:"quickstart.en-US",setup(o,{expose:s}){return s({frontmatter:{}}),(i,r)=>(n(),a("div",t,p))}};export{d as default};
